...
export default function Footer(){
    return(
        ...
        <div id="poppins" className="credits w-[95%] flex items-center justify-between  h-10 ">
          ...
          <div className="sign">
            <h1>Designed & Developed by <span className="text-blue-500"><a href="https://www.linkedin.com/in/ridhampatel2k4/">Ridham Patel</a></span> , <a href="https://www.linkedin.com/in/harshsuthar28/">Harsh Suthar</a>  (Coding Brigades)</h1>
          </div>
        </div>
        </div>
